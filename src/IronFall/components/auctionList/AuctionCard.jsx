    ...
    const BetInPot = () => {
        ...
        const bet = async () => {
            ...
            try {
                ...
                const tx = await downInstalmentPot(auctionId, amountInWei, signer)
                setTxHash(tx)
                ...
                >
                    <div className="w-full md:w-2/5 bg-gradient-to-b from-slate-900 to-gray-800 text-white rounded-xl p-6 shadow-xl relative">
                        ...
                        <div className="space-y-4 mb-6">
                            ...
                            <p className="flex justify-between">
                                <span className="font-semibold">Current Lower Bid:</span>
                        ...
                        <div className="flex flex-col text-center space-y-4">
                            <button
                                onClick={bet}
                                disabled={isLoading}
                                className={`flex items-center justify-center w-full py-3 px-6 font-bold rounded-lg shadow-lg transform transition-all duration-500 ease-in-out text-white ${isLoading
                ...
                >
                    ...
                    <div className="relative">
                        ...
                        <div className="flex flex-col gap-4 mb-8 text-gray-300">
                            <div className="flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-red-500/10 to-orange-500/10 hover:bg-gradient-to-r   border border-red-700 ">
                        ...
                        <div className="flex-row md:flex-col space-y-3 gap-10">
                            <Link
                                className="group inline-flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-gradient-to-t from-pink-500 via-red-400 to-yellow-500 hover:opacity-90 transition-opacity  font-bold text-lg"
                                to={`/app.ironFall/DownwardAuctionId/${auctionId}`}
                            >
                                Show Auction Page
                            </Link>
                        </div>
