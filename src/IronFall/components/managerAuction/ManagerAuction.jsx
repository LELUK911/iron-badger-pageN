...
export const ManagerAuction = () => {
    ...
    const fetchData = async () => {
        try {
            const _auctionList = await showDownAuctionList()
                ...
                <div className="space-y-4">
                    <div className="flex flex-col sm:flex-row items-center sm:space-x-4 space-y-4 sm:space-y-0">
                        <div className="flex items-center space-x-2">
                            <label className="font-semibold">Lock Balance:</label>
                        ...
                        <div className="flex flex-col sm:flex-row items-center sm:space-x-2 space-y-2 sm:space-y-0">
                            ...
                            <button
                                ...
                                disabled={isLoading}
                                className={`w-full sm:w-auto transform transition-transform duration-300 ease-in-out text-white font-bold py-2 px-4 rounded-lg shadow-lg ${isLoading
                ...
                <div className="space-y-8 bg-gray-800 p-6 rounded-lg shadow-xl w-full max-w-lg">
                    ...
                    <div className="space-y-4">
                        ...
                        >
                            ...
                            <button
                                onClick={fetchData}
                                className="mx-4 w-full sm:w-auto bg-gradient-to-r 0 text-sm   from-yellow-500 to-yellow-700   hover:to-yellow-800 text-white font-bold py-1 px-2 rounded-lg shadow-lg transform transition-transform duration-300 ease-in-out hover:scale-105 hover:brightness-110 active:scale-95"
                            >
                                Refresh
                            </button>
                        </label>
