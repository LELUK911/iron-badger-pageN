...
export const UpwardCard = ({ id }) => {
    ...
    const fetchData = async () => {
        try {
            const _auctionInfo = await showAuction(id)
    ...
    const handleInputChange = (e) => {
        ...
        if (!isNaN(value) && value >= 0) {
            setAmountBet(value); // Aggiorna solo con numeri validi
        }
    };
    const addValue = () => {
                ...
                <div className="flex-1 bg-slate-700 rounded-lg p-6">
                        ...
                        <div className="text-gray-300 text-lg space-y-6">
                            ...
                            <div className="border-b-2 pb-4">
                                ...
                                <div className="flex justify-between">
                                    <p><strong>Initial Price:</strong></p>
                                ...
                                <div className="flex justify-between">
                                    <p><strong>Amount of Pact:</strong></p>
                    ...
                    <div className="mt-6">
                        ...
                        <button
                            ...
                            className={`flex items-center justify-center w-full py-2 px-4 rounded-md mt-4 text-white transition-colors duration-300 ease-in-out ${isLoadingBid ? "bg-gray-500 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"
                                }`}
                        >
                            {isLoadingBid ? (
                                <>
                        ...
                        {/* Withdraw Auctioned Pact Button */}
                        <button
                            onClick={async () => {
                    ...
                    <div className="mt-6 bg-gray-600 rounded-lg p-4">
                        <h4 className="text-xl font-semibold text-gray-100 mb-4">Bidding Activity Log</h4>
