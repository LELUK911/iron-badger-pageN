export const AuctionManagmentDoc = () => {
    return (
        <div className="p-6 bg-slate-800 text-white rounded-lg">
            ...
            <p className="mb-4">
                ...
                section. By selecting the listed Pact, users can access a detailed auction
                management panel.
            </p>

            <h3 className="text-2xl font-semibold mb-3">Auction Details:</h3>
            <ul className="list-disc list-inside space-y-2">
                <li><strong>Pact ID:</strong> Unique identifier of the listed Pact.</li>
                <li><strong>Current Leading Bidder:</strong> The address of the user currently leading the auction
                    (initially corresponds to the seller).</li>
                <li><strong>Units Listed:</strong> Quantity of Pacts available for bidding.</li>
            ...
            <ul className="list-disc list-inside space-y-2">
                <li>
                    <strong>Close Auction:</strong> Finalizes the auction, transferring ownership of the
                    Pact to the highest bidder and allocating the bid amount to the seller.
                </li>
                <li>
