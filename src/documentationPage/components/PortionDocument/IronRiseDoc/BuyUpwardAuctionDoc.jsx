export const BuyUpwardAuctionDoc = () => {
    return (
        <div className="p-6 bg-slate-800 text-white rounded-lg">
            <h2 className="text-3xl font-bold mb-4">Participating in an Auction Lot</h2>
    
            <p className="mb-4">
                To participate in an available auction lot, navigate to the <strong>“Auctions”</strong>
            ...
            <p className="mb-4">
                Once the auction concludes, the <strong>winner</strong> can finalize the closure in case
