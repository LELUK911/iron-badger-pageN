export const SellDownAuctionLotDoc = () => {
    return (
        <div className="p-6 bg-slate-800 text-white rounded-lg">
            ...
            <p className="mb-4">
                ...
                within <strong>Iron Fall Auction</strong>.
            </p>
            ...
            <p className="mb-4">
                ...
                <strong>“Iron Fall Auction”</strong> from the available options.
            </p>
    
            <p className="mb-4">
                On the <strong>Iron Fall Auction</strong> page, within the <strong>“New Auction”</strong> section,
                users can search for the Pact they wish to list and complete the auction form.
            </p>
    
            <p className="mb-4">
                In both cases, users must <strong>authorize</strong> the <strong>Iron Fall Auction</strong> contract
